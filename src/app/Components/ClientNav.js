...
export default function ClientNav() {
  ...
  // Handle search filtering by title and tags
  useEffect(() => {
    if (searchQuery.trim() === "") {
      setFilteredProducts([]);
  ...
  return (
    <>
      <nav className="w-full max-w-screen-2xl mx-auto flex justify-between items-center px-6 py-5 fixed top-0 z-50 bg-black border-b border-white/10 shadow-[0_4px_10px_rgba(17,24,39,0.5)]">
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="relative" ref={searchRef}>
            ...
            {isSearchDropdownOpen && (
              <div className="absolute top-full left-0 mt-2 w-full max-h-64 overflow-y-auto bg-gradient-to-br from-gray-900 to-black border border-white/20 rounded-lg shadow-lg z-50 hover:shadow-xl transition-all duration-300">
        ...
        {/* Mobile Menu Button and WhatsApp Icon */}
        <div className="md:hidden flex items-center space-x-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gradient-to-br from-gray-900 to-black text-white px-3 py-2 rounded-full font-medium text-sm border border-white/20 transition-all duration-300 hover:bg-white/10 hover:shadow-lg hover:scale-105 flex items-center gap-2 animate-pulse shadow-[0_0_15px_rgba(255,255,255,0.3)]"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
          ...
          {/* Mobile Menu Button */}
          <button
            className="text-white hover:text-gray-300 transition-all duration-300 bg-gradient-to-br from-gray-900 to-black p-2 rounded-full hover:shadow-lg"
